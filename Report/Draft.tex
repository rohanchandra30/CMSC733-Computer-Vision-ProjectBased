...
%% ( http://www.latex-project.org/ ) version 1.5, and may be freely used,
%% distributed and modified. A copy of the LPPL, version 1.5, is included
...
% noadjust option (cite.sty V5.8 and later) if you want to turn this off
% such as if a citation ever needs to be enclosed in parenthesis.
% cite.sty is already installed on most LaTeX systems. Be sure and use
% version 5.0 (2009-05-20) and later if using hyperref.sty.
...
% subfig.sty version 1.5, 2005/06/28) as this is will preserve IEEEtran.cls
...
\title{CMSC733-Project 3: Structure From Motion}


% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Rohan Chandra}
\and
\IEEEauthorblockN{Swati Singhal}
}
...
%James Kirk\IEEEauthorrefmark{5}, 
%Montgomery Scott\IEEEauthorrefmark{5} and
%Eldon Tyrell\IEEEauthorrefmark{4}}
%\IEEEauthorblockA{\IEEEauthorrefmark{1}School of Electrical and Computer Engineering\\
%Georgia Institute of Technology,
%Atlanta, Georgia 50552--0250\\ Email: see http://www.michaelshell.org/contact.html}
%\IEEEauthorblockA{\IEEEauthorrefmark{2}Twentieth Century Fox, Springfield, USA\\
%Email: homer@thesimpsons.com}
%\IEEEauthorblockA{\IEEEauthorrefmark{5}Starfleet Academy, San Francisco, California 96678-2591\\
%Telephone: (800) 555--1212, Fax: (888) 555--1212}
%\IEEEauthorblockA{\IEEEauthorrefmark{4}Tyrell Inc., 125 Replicant Street, Los Angeles, California 90210--4521}}
...
% in the abstract
\begin{abstract}
Structure from Motion from multiple views using bundle adjustment. We used a different solver algorithm for non-linear triangulation. We also iclude a pruning algorithm after non linear triangulation that helps in reducing re-projection error.
\end{abstract}
...
% \begin{center} \bfseries EDICS Category: 5-BBND \end{center}
% \fi
%
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7in]{output.jpg}
\caption{Visual SfM output}
\label{fig_sim}
\end{figure}
...
\section{Two View Reconstruction}

We perform the following algorithm:


\subsection{RANSAC on matching pairs}

Raw Feature Matching:

\begin{figure}[H]
\centering
\includegraphics[width=3in]{After_RANSAC.jpg}
\caption{Feature matching before RANSAC}
\label{fig_sim}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=3in]{RANSAC.jpg}
\caption{Feature matching after RANSAC}
\label{fig_sim1}
\end{figure}
...
\[
\begin{bmatrix}
    -1.8459e^{-07} & -7.8618e^{-6} & .0024\\
     8.9358e^{-06} & 1.2166e^{-07} & -0.0056\\
     -0.0035 & 0.0039 & 1\\
 \end{bmatrix}
\]
...
\[
\begin{bmatrix}
    -0.0119 & -0.9265 & -0.2957\\
     0.9906 & 0.0062 & 0.0425\\
     0.1305 & -0.2226 & -0.0656\\
 \end{bmatrix}
\]



\subsection{2D Reprojection After Non - Linear Triangulation}
...
\begin{figure}[H]
\centering
\includegraphics[width=3in]{2view_repo_img1.jpg}
\label{fig_sim}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=3in]{2view_repo_img2.jpg}
\caption{3D reprojection of 2D points. Blue indicate original points. Green indicate projected points. Error is displayed at the top}
\label{fig_sim}
\end{figure}
...
\subsection{3D visualiztion of Linear and Non Linear Triangulated Points}
Figure 5 shows the initial results of our algorithm. \\

\begin{figure}[H]
\centering
\includegraphics[width=4in]{2view_topview.jpg}
\caption{Top View Reconstruction for 2 views}
\label{fig_sim}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=4in]{multiple_view_topview.jpg}
\caption{Top View Reconstruction after Bundle Adjustment}
\label{fig_sim}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=4in]{ObliqueView.jpg}
\caption{Oblique View Reconstruction after Bundle Adjustment}
\label{fig_sim}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=3in]{SideView.jpg}
\caption{Side View Reconstruction after Bundle Adjustment}
\label{fig_sim}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=4in]{laptops_EC.jpg}
\caption{Images for Extra Credit}
\label{fig_sim}
\end{figure}
...
After securing the images that we wanted, we used the vl\_feat library to perform feature detection and matching. We found that the vl\_feat library considerably outperforms the SURF points from MATLAB. We procured over 2000 matching points from the former while obtaining only 400 from the latter.\\

The results of RANSAC can be shown below:\\

\begin{figure}[H]
\centering
\includegraphics[width=3in]{laptop_ransac.jpg}
\caption{RANSAC after feature matching}
\label{fig_sim}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=5in]{laptop_repo1.jpg}
\caption{3D reprojection of 2D points. Blue indicate original points. Green indicate projected points. Error is displayed at the top}
\label{fig_sim}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=4in]{laptop_front.jpg}
\caption{Front View. Notice the familiarity}
\label{fig_sim}
\end{figure}
...
%\begin{figure}[!t]
%\centering
%\includegraphics[width=2.rin]{myfigure}
...
%\begin{figure*}[!t]
%\centering
%\subfloat[Case I]{\includegraphics[width=2.rin]{box}%
%\label{fig_first_case}}
%\hfil
%\subfloat[Case II]{\includegraphics[width=2.rin]{box}%
...
%\IEEEtriggercmd{\enlargethispage{-rin}}
